...
<script>
    $(document).ready(function() {
        ...
        $('body').on('click', '.editPackage', function () {
            ...
            $('.invalid-feedback').text('');
            $('input').removeClass('is-invalid');
            let url = '{{ route("packages.edit", ":id") }}'.replace(':id', packageId);
        ...
        $('#edit-package-form').submit(function(e) {
            ...
            let url = '{{ route("packages.update", ":id") }}'.replace(':id', packageId);
        ...
        $('body').on('click', '.deletePackage', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = '{{ route("packages.destroy", ":id") }}'.replace(':id', packageId);
                    $.ajax({
                        type: "DELETE",
                        url: url,
