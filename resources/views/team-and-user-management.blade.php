                                ...
                                <form id="add-user-form">
                                    ...
                                    <div class="form-box">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-btn">
                                                    <button type="submit" class="btn web-btn" id="create-user-btn">Create
                                                        User</button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Drag any lead/client to a different teammate" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </form>
            ...
            $('body').on('click', '.deleteUser', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let url = '{{ route('team-and-user-management.destroy', ':id') }}'.replace(
                            ':id', userId);
                        $.ajax({
                            type: "DELETE",
                            url: url,
